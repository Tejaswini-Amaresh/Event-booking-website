                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <div class="login-register-btn mr-50">
                                        <a href="register.php" id="loginBtn">New User ? <br> Register!</a>
                                    </div>
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h2 data-animation="fadeInUp" data-delay="300ms">Best Place for Music to the addicted ones!!!</h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Discover <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <div class="ablums-text text-center mb-70">
                        <h3>Music is love,Love is music,music is life and I love my life</h3>
                ...
                <div class="col-12">
                    <div class="albums-slideshow owl-carousel">
                        ...
                        <div class="single-album">
                            ...
                            <div class="album-info">
                                <a href="#">
                                    <h5>Yaara teri yaari</h5>
                                </a>
                                <p>Four more shorts please</p>
                            </div>
                        </div>
                    ...
                    <div class="new-hits-area mb-100">
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="100ms">
                            <div class="first-part d-flex align-items-center">
                                ...
                                <div class="content-">
                                    <h6>Milne hai mujhse aayi</h6>
                                    <p>Aashiqui 2</p>
                                </div>
                            </div>
                            <audio preload="auto" controls>
                                <source src="audio/milne.mp3">
                            </audio>
                        </div>
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="350ms">
                            <div class="first-part d-flex align-items-center">
                                ...
                                <div class="content-">
                                    <h6>Tera yaar hoon mai</h6>
                                    <p>Sonu ke titu ki sweety</p>
                                </div>
                            </div>
                            <audio preload="auto" controls>
                                <source src="audio/terayaarhoonmai.mp3">
                            </audio>
                        </div>
                    </div>
                </div>
